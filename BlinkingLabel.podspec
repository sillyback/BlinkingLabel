...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/sillyback/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Sillyback' => 'chung.nguyenduc@nhatcuong.com' }
  s.source           = { :git => 'https://github.com/sillyback/BlinkingLabel.git', :tag => s.version.to_s }
